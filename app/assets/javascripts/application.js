...
// %script{:src => "js/libs/jquery-ui-1.8.21.custom.min.js"}
// %script{:src => "js/libs/jquery.ui.touch-punch.min.js"}
// %script{:src => "js/libs/bootstrap/bootstrap.min.js"}
// %script{:src => "js/Theme.js"}
// %script{:src => "js/Charts.js"}
// %script{:src => "./js/plugins/excanvas/excanvas.min.js"}
...
// %script{:src => "js/demos/charts/line.js"}
// %script{:src => "js/demos/charts/donut.js"}
//
...
//= require Theme
//= require Charts
//= require plugins/excanvas/excanvas.min
